...
public class NfcPlugin extends CordovaPlugin {
    ...
    private void unshareTag(CallbackContext callbackContext) {
        callbackContext.error("Android Beam sharing is not supported on Android 10+");
    }
    ...
    private void handover(JSONArray data, CallbackContext callbackContext) throws JSONException {
        callbackContext.error("Android Beam is not supported on Android 10+");
    }
    ...
    private void startNdefPush(final CallbackContext callbackContext) {
        callbackContext.error("Android Beam (P2P push) is not supported on Android 10+");
    }
